...
class Premium extends Controller {
	...
	public function get(): void {
        ...
        App::$page['title'] = "Premium Content - TechSero";
		App::$meta->set('description', 'This is where you will find our "Premium" tier content that is only available to paying customers.');
