...
-->    
    <div class="cs-container">
        ...
        <a href="" class="cs-logo" aria-label="back to home">
            <img src="https://techsero.com/images/techsero-logo-plain.png" alt="logo" !width="197" !height="43" aria-hidden="true" decoding="async">
        </a>
        <!--Navigation List-->
        <nav class="cs-nav" role="navigation">
            ...
            <div class="cs-ul-wrapper">
                <ul id="cs-expanded" class="cs-ul" aria-expanded="false">
                    ...
                    <li class="cs-li">
                        <a href="/contentcreation" class="cs-li-link cs-active">
                            Content Creation
                        </a>
                    </li>
                    <li class="cs-li">
                    ...
                    <li class="cs-li cs-dropdown" tabindex="0">
                        ...
                        <ul class="cs-drop-ul">
                            <li class="cs-drop-li">
                                <a href="" class="cs-li-link cs-drop-link">Hubzilla Fediverse Server</a>
                            </li>
                            <li class="cs-drop-li">
                                <a href="" class="cs-li-link cs-drop-link">Web Design &amp; Development</a>
                            </li>
                            <li class="cs-drop-li">
                                <a href="" class="cs-li-link cs-drop-link">Domain Name Registration</a>
                            </li>                            
                        </ul>
                    </li>
                    -->
