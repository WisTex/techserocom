...
<section id="services-1378">
    <div class="cs-container">
        <div class="cs-content">
            {{if $isLoggedIn && $accessAllowed}}
                <h3>Welcome to "Starter" tier content!</h3>
                <p class="cs-text pb-3">Enjoy your subscriber-exclusive content.</p>
            {{else}}
                <h3>Access Denied!</h3>
                <p class="cs-text pb-3">You must <a href="login">log in</a> and <a href="shop">subscribe</a> to see this content.</p>
            {{/if}}         
        </div>
    </div>
</section>
